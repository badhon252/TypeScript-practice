...
function userInfo(user:userType, id:StringOrNumber):string{
    console.log(`User Info: ${user.name}, ${user.age}, User Id: ${id}`);
}
userInfo({name:"Khalid Hossain", age:22}, "193-011-011");