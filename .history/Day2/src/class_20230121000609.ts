...
class Customer{
    ...
    customerInfo(){
        console.log(`
            ...
            and his address is ${this.address}
         `)
    }

    customersOrder(product:string){
        console.log(`${this.name} has ordered some ${product}`)
    }
}

const customer1 = new Customer("khalid Hossain", 22, "Barishal");